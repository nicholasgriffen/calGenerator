...
function sendCsvToCalendar(req, res, next) {
    ...
    res.status(200).send(`Your calendars are being made, please check your Galvanize account in a little while for calendars called ${globals.JUNIOR_COHORT} Academic Calendar and ${globals.SENIOR_COHORT} Academic Calendar`)
}
